...
public class MovieService : IMovieService
{
    ...
    public async Task<int> CountAsync(string? title, int? yearOfRelease, CancellationToken cToken = default)
    {
        return await _repository.CountAsync(title, yearOfRelease, cToken);
    }
}